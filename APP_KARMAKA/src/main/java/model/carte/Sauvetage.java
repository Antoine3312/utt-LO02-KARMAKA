...
/**
 * La classe Sauvetage représente une carte du jeu avec le pouvoir spécifique "Ajoutez à votre Main une des 3 dernières cartes de la Fosse".
...
public class Sauvetage extends Carte {
    ...
    public Sauvetage(Renderable renderable) {
        super(renderable);
        this.nom = "Sauvetage"; // Nom de la carte
        ...
        this.intitulePouvoir = "Ajoutez à votre Main une des 3 dernières cartes de la Fosse"; // Description du pouvoir de la carte
    }

    /**
     * Méthode pour exécuter le pouvoir de la carte Sauvetage.
     *
